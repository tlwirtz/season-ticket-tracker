        ...
        return (
            <div className="match-detail-container">
                <div className="match-detail-item">
                    ...
                    <p>
                        All tickets are located in the Southern End of Royal Brougham Park (Lumen
                        Field) in ECS general admission sections 121, 122, 123.
                    </p>
                    <p>
                        These seats are not for the faint of heart. There will be yelling, drinking,
                        chanting, jumping, and profanity. Your view will be obstructed for portions
                        of the match due to flags, banners and tifo.
                    </p>
                    <p>
                        This section expects full partcipation, so if you are looking for a nice,
                        relaxing expereince, this isn't the section for you. If you're looking for
                        one of the most authentic and exciting ways to expereince American soccer,
                        then step right up.
                    </p>

                    <p>
                        Check out this{' '}
                        <a href="https://www.youtube.com/watch?v=R5FQsrRSMFw">link</a> to get a feel
                        for what it's like to sit with the Emerald City Supporters!
                    </p>
                    <p>We'll see you in the terraces.</p>

                    <h3 className="soft-grey-text">How Do I Get My Tickets?</h3>
                    <p>
                        Once tickets are released, PDFs will be emailed within 24 hours of claiming
                        your match.
                    </p>
                    ...
                    <p>
                        Don't panic if you must cancel within 48 hours of match day! Just let me
                        know as soon as you can and we can work together to find a solution.
                    </p>
                </div>
            </div>
        );
